namespace ex08_generics
{
    ...
    {
        // 배열 복사 기능 -> 일반화 프로그래밍
        // 메서드 뒤에 <T>, 각 매개변수(입력)의 타입 대신 T로 변경
        // 굳이 T로 정해진 것은 아니다. 다른 문자도 가능
        ...
        static void Main(string[] args)
        {
            ...
            CopyArray<int>(array1, array2); // <int> 의 색을 보면 희미해져 있는 상태인데 생략도 가능하다는 것이다.
            ...
            CopyArray<float>(array3, array4); // 자료형이 달라서 복사가 안된다. 그래서 float 자료형을 입력받는 CopyArray 함수를 만들어준다.
