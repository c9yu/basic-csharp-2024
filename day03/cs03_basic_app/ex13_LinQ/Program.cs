...
namespace ex13_LinQ
{
    class Profile
    {
        ...
        public int Height { get; set; } // 키가 -21억 ~ +21억 사이의 값이 들어간다. 
        public int Age
        {
            get => age;
            set
    ...
    class Product
    {
        ...
        internal class Program
        {
            static void Main(string[] args)
            {
                ...
                new Profile {Name = "RM", Height = 180, Age = 29}
            };
                ...
                // group by : sql에서 group by를 사용하면, 집계함수가 필수인데 LINQ에서는 그런 제약 없다.
                ...
                {
                    Console.WriteLine($"- 175 cm 미만? : {group.GroupKey}");
                ...
                var outerJoinResult = from pf in arrProfiles
                                      ...
                                      from pr in ps.DefaultIfEmpty(new Product() { Title = "작품 없음" })
                                      select new
                                      {
                                          Name = pf.Name,
                                          Work = pr.Title,
